...
describe Printer do
  ...
  it 'prints a list of journeys' do
    ...
    "1) #{dbl_station1.name} [#{dbl_station1.zone}] "\
    "to #{dbl_station2.name} [#{dbl_station2.zone}] - "\
    "Fare: #{journey1.fare}\n2) #{dbl_station1.name} "\
    "[#{dbl_station1.zone}] to #{dbl_station2.name} "\
    "[#{dbl_station2.zone}] - Fare: #{journey1.fare}\n"
  end
